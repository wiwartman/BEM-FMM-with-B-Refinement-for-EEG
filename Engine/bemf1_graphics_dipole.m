...
% Normalize to 1 mm
direction       = strdipolePplus-strdipolePminus;
direction       = direction/norm(direction);
center          = 0.5*(strdipolePplus+strdipolePminus);
strdipolePplus  = center + 0.5*direction;
strdipolePminus = center - 0.5*direction;

    sz = 50; %   circle size in points squared
    
    if type == 0        % volume
        hold on;
        scatter3(strdipolePplus (:, 1), strdipolePplus (:, 2), strdipolePplus (:, 3), sz, 'MarkerEdgeColor',[1 0 0],...
                                                                    'MarkerFaceColor',[1 0 0],...
                                                                    'LineWidth',1)    
        scatter3(strdipolePminus (:, 1), strdipolePminus (:, 2), strdipolePminus (:, 3), sz, 'MarkerEdgeColor',[0 0 1],...
