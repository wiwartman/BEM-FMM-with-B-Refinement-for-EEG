...
color   = [[1 0 0]; [0 0 1]; [1 0 1]; [0.5 0.5 0.5]];
for m = countXY
...
% General settings
title(['Cross-section in the transverse plane at Z = ' num2str(Z) ' m']);
xlabel('x, m'); ylabel('y, m');
axis 'equal';  axis 'tight'; 
set(gcf,'Color','White');
hold on;
bemf1_graphics_dipole(strdipolePplus, strdipolePminus, strdipoleCurrent, 3);
...
set(gcf,'Color','White');
hold on;
bemf1_graphics_dipole(strdipolePplus, strdipolePminus, strdipoleCurrent, 1);
...
set(gcf,'Color','White');
hold on;
bemf1_graphics_dipole(strdipolePplus, strdipolePminus, strdipoleCurrent, 2);
